...
日:ゲスト:それに同意します、兄弟。蜂蜜をください。
  ...
  <TabItem value="word list" label="単語">
    - 口語表現（Colloquialisms）
        - warm-up act: 前座
        - big cheese: 重要人物
        - scratching his head: 首をかしげている
        - theological shell game: 神学的なペテン
        - spiritual gentrification: スピリチュアルな高級化
        - theological football: 神学的なフットボール
    - 慣用句（Idioms）
        - the kicker: 肝心なところ
        - step right up: さあさあ、寄ってらっしゃい
        - pin the miracle on the Savior: 救世主に奇跡をピンで留める
        - shell game: ペテン
        - pass the honey: 蜂蜜をください
    - スラング（Slang）
        - hype man: 盛り上げ役
        - carnival barker: 呼び込み屋
        - playing musical chairs: 椅子取りゲームをしている
        - high priest: 高位聖職者
        - black humor: ブラックユーモア
        - last piece of truth: 最後の真実
        - influencer: インフルエンサー
    - 比喩（Metaphors）
        - bugs and bee barf: 虫と蜂の吐瀉物
        - chopping him up: 彼を切り刻む
    - 句動詞（Phrasal Verbs）
        - stand up to: 立ち向かう
        - miss the point: 肝心な点を見失う
    - 専門用語（Jargon）
        - Gospel writers: 福音書記者
        - kingdom of heaven: 天の国
        - spiritual doppelganger: 霊的なドッペルゲンガー
    - 決まり文句（Clichés）
        - speak truth to power: 権力に真実を語る
    - インターネットスラング（Internet slang）
        - post that on Facebook: Facebookに投稿する
        - watching cat videos: 猫の動画を見る
        - Instagram: インスタグラム
        - #DesertLife: #砂漠の生活
        - #BaptismGoals: #洗礼の目標
    - ポップカルチャーからの引用（Pop culture references）
        - Action Figure: アクションフィギュア
        - Baptismal Splash Action: 洗礼スプラッシュアクション
  </TabItem>
</Tabs>
