...
英: Joe: So, they had to wait until 20 people took the big sleep to figure out that safety isn't just a cute suggestion? That's…… that's just fucking great.  
...
英: Guest: It's a fucking masterclass in misdirection. And when someone does speak up, when someone does try to change things, they get labeled as a troublemaker, a radical. "Oh, look at Mr. Safety over here, wanting boats that don't sink and buildings that don't collapse. What a buzzkill!"  
...
日: ジョー：アーメンだ。クソに溺れないように乾杯しようぜ、友よ。そして溺れるとしても、あの貪欲な野郎どもを何人か道連れにしてやろうぜ。
  ...
  - 口語表現（Colloquialisms）
      - waltzed in: まるで自分の家にでも入るように入ってきた
      - a kick in the nuts: 金玉蹴り
      - kick the bucket: 大いなる眠りにつく
      - steer this ship around: 船の向きを変える
  - 慣用句（Idioms）
      - Davy Jones' locker: 海の藻屑になる
      - thoughts and prayers: お祈りします
      - safety isn't just a cute suggestion: 安全は単なるかわいい提案ではない
      - wake these fuckers up: こいつらを目覚めさせる
      - heads up their own asses: 自分の尻の中に頭を突っ込む
      - a circle jerk: 集団自慰行為
      - keep your eyes open: 目を見開いてろ
      - make some goddamn noise: クソでかい声を上げる
      - middle fingers raised high: 中指を高々と掲げる
      - make sure we take a few of those greedy bastards down with us: 貪欲な野郎どもを道連れにする
  - スラング（Slang）
      - fucking death wish: 死に物狂い
      - goddamn tragedy: くそったれな悲劇
      - retarded cousin: 知恵遅れの従兄弟
      - clusterfuck: 大混乱
      - jerking off to hentai: ヘンタイでシコシコする
      - floating coffin: 浮遊棺桶
      - punchline: オチ
      - buzzkill: 空気読めないやつ
      - drowning in bullshit: クソに溺れる
  - 比喩（Metaphors）
      - one-way trip to Davy Jones' locker: 海の藻屑になる
      - watching a train wreck: 列車事故を見ているよう
      - selling our safety to the lowest bidder: 安全を最低価格で売り飛ばしてる
      - sinking ship: 沈む船
  - 句動詞（Phrasal Verbs）
      - pull their heads out: 頭を引っ張り出す
      - shrug it off: 肩をすくめる
      - squeeze every last yen: 最後の一円まで搾り取る
      - cover their asses: 自分の尻を守る
  - 専門用語（Jargon）
      - government oversight: 政府の監督
      - quarterly reports: 四半期報告
